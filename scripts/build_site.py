...
def render_recipe_page(recipe: dict) -> str:
    ...
    return f'''<!doctype html><html lang="sv"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{html.escape(recipe['title'])} · Alltid bra mat på Säteriet</title><link rel="stylesheet" href="../style.css"></head><body>
<nav class="mobile-top"><a class="iconbtn" href="../index.html#recept" aria-label="Tillbaka">‹<span>Tillbaka</span></a><div class="brand"><strong>Alltid bra mat på Säteriet</strong><em>Recept, minnen och måltider sedan 1860</em></div><a class="iconbtn" href="../index.html" aria-label="Hem">⌂<span>Hem</span></a></nav>
<main class="recipe-page"><article class="recipe-content"><p class="eyebrow">{html.escape(recipe['category'])}</p><h1>{html.escape(recipe['title'])}</h1>{f'<p class="recipe-facts">{facts_html}</p>' if facts_html else ''}{source_html}<div class="recipe-markdown">{body_html}</div></article></main>
<footer><img src="../assets/signature.webp" alt="Alltid bra mat på Säteriet"><p>Säteriet · anno 1860 · en levande receptsamling</p></footer></body></html>'''
...
def render_index(recipes: list[dict]) -> str:
    ...
    return f'''<!doctype html><html lang="sv"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alltid bra mat på Säteriet</title><link rel="stylesheet" href="style.css"></head><body>
<nav class="mobile-top"><button class="iconbtn" aria-label="Meny">☰<span>Meny</span></button><div class="brand"><strong>Alltid bra mat på Säteriet</strong><em>Recept, minnen och måltider sedan 1860</em></div><a class="iconbtn" href="#recept" aria-label="Recept">⌕<span>Recept</span></a></nav>
<header id="hem" class="hero hero-plain"><div class="hero-copy"><p class="eyebrow">SÄTERIET · ANNO 1860</p><h1>Välkommen till vår receptsamling</h1><div class="rule">❦</div><p>Här samlar vi favoritrecept, rätter vi vill laga igen och måltider som hör ihop med en särskild kväll eller årstid.</p></div></header>
<main><section id="teman" class="category-strip">{category_cards}</section><div id="recept">{''.join(sections)}</div><section class="about"><div class="ornament">❦</div><p>”God mat smakar ännu bättre i gott sällskap”</p></section></main>
<footer><img src="assets/signature.webp" alt="Alltid bra mat på Säteriet"><p>Säteriet · anno 1860 · en levande receptsamling</p></footer></body></html>'''
