...
<main class="recipe-page"><article class="recipe-content"><button class="print-button" type="button" onclick="window.print()" aria-label="Skriv ut recept" title="Skriv ut recept">{print_icon}<span>Skriv ut</span></button><p class="eyebrow">{html.escape(recipe['category'])}</p><h1>{html.escape(recipe['title'])}</h1>{f'<p class="recipe-facts">{facts_html}</p>' if facts_html else ''}{source_html}<div class="recipe-markdown">{body_html}</div></article></main>
